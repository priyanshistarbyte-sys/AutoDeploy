...
class MainSiteDeploymentService
{
    ...
    /**
     * Same combined single-round-trip approach as the Sub-Site
     * pipeline: create folder, extract+flatten, replace [AD_Unit],
     * write rewrite rules, reload Nginx - all in ONE ssh->execute().
     */
